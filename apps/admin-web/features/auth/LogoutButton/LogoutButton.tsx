...
>(useLogoutButton, ({ logout, variant, isLoggingOut }) => {
  ...
  return (
    <button
      type="button"
      disabled={isLoggingOut}
      className="flex items-center gap-3 w-full px-4 py-2.5 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 transition motion-reduce:transition-none outline-none select-none text-left focus-visible:ring-2 focus-visible:ring-red-600/40 disabled:opacity-60 disabled:cursor-not-allowed"
      onClick={logout}
    >
