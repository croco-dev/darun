        ...
        <SectionWrapper background="subtle" spacing="md">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 gap-5 text-sm leading-relaxed text-dark-700 md:grid-cols-3 md:gap-6 sm:text-base">
              <div className="flex flex-col gap-3 rounded-card-lg border border-dark-150/80 bg-white p-6 shadow-card transition-all duration-200 hover:-translate-y-1 hover:border-dark-250 hover:shadow-card-hover">
              ...
              <div className="flex flex-col gap-3 rounded-card-lg border border-dark-150/80 bg-white p-6 shadow-card transition-all duration-200 hover:-translate-y-1 hover:border-dark-250 hover:shadow-card-hover">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-blue-500/20 bg-blue-500/10 text-blue-600">
                  <Layers size={22} />
                </div>
                <h3 className="text-base font-bold tracking-tight text-dark-900 sm:text-lg">
              ...
              <div className="flex flex-col gap-3 rounded-card-lg border border-dark-150/80 bg-white p-6 shadow-card transition-all duration-200 hover:-translate-y-1 hover:border-dark-250 hover:shadow-card-hover">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-emerald-500/20 bg-emerald-500/10 text-emerald-600">
                  <ShieldCheck size={22} />
                </div>
                <h3 className="text-base font-bold tracking-tight text-dark-900 sm:text-lg">
