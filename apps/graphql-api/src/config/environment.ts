...
assert(JSON.parse(process.env['FIREBASE_PRIVATE_KEY'])['privateKey'], 'FIREBASE_PRIVATE_KEY not provided');
...
export const FIREBASE_PRIVATE_KEY = JSON.parse(process.env['FIREBASE_PRIVATE_KEY'])['privateKey'] as string;
