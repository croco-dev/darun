...
export const FeatureItem = ({}: FeatureItemProps) => (
  <Flex
    px="16px"
    py="12px"
    borderRadius="8px"
    ...
    <VStack gap="16px">
      <HStack alignItems={'center'} gap={'12px'}>
        ...
        <VStack>
          ...
          <Text color={'colors.dark.600'} fontWeight={'fontWeights.normal'} fontSize={'14px'} letterSpacing={'-.05px'}>
      ...
      <HStack gap={'8px'} width={'max-content'} overflow={'auto'}>
        <Image
          src={'https://via.placeholder.com/800x1600.png?text=PhoneSize'}
          alt={'asd'}
          sizes="800px"
          fill
          className={css`
        ...
        />
        <Image
          src={'https://via.placeholder.com/1200x800.png?text=OgSize'}
          alt={'asd'}
          sizes="1200px"
          fill
          className={css`
        ...
        />
        <Image
          src={'https://via.placeholder.com/1600x900.png?text=DesktopSize'}
          alt={'asd'}
          sizes="1600px"
          fill
          className={css`
