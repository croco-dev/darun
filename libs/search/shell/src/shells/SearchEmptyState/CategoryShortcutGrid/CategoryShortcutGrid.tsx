  ...
  return (
    ...
    >
      {categories.map(cat => (
        ...
        >
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-dark-150/70 bg-gradient-to-br from-surface-50 to-surface-100 text-lg leading-none shadow-2xs transition-all duration-200 group-hover:scale-110 group-hover:border-dark-300 group-hover:bg-white motion-reduce:transform-none">
