    ...
    compoundVariants: [
      {
        ...
        color: "primary",
        className:
          "border-dark-900 bg-dark-900 text-white hover:bg-dark-800 hover:border-dark-800 active:bg-dark-900",
      },
      {
        variant: "base",
        color: "secondary",
        className:
          "border-transparent bg-transparent text-dark-900 hover:bg-dark-100 active:bg-dark-150",
      },
      {
        variant: "contained",
        color: "primary",
