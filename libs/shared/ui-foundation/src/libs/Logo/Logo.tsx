...
const dark = 'colors.dark.900';

export function Logo({ size, colorScheme = 'dark' }: LogoProps) {
  return (
    <Box as="svg" width={size} height={size} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <Box
        as="path"
        fillRule="evenodd"
        clipRule="evenodd"
        d="M18 0C4.71138 0 0 4.71138 0 18C0 31.2905 4.71138 36 18 36C31.2886 36 36 31.2905 36 18C36 4.71138 31.2886 0 18 0Z"
        fill={colorScheme === 'dark' ? dark : '#fff'}
      />
      <Box
        as="path"
        ...
        fill={colorScheme === 'dark' ? '#fff' : dark}
      />
    </Box>
  );
}
