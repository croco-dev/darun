        ...
        rank === 1
          ...
          : rank === 2
            ...
            : rank === 3
              ...
              : 'border border-dark-150/90 bg-surface-100 font-bold text-dark-600 shadow-2xs group-hover:border-dark-300 group-hover:bg-white group-hover:text-dark-900'
      }`}
    >
      {rank}
    </span>
