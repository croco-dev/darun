...
export const ProductPhotoSection = ({ slug }: ProductPhotoSectionProps) => {
  ...
  return (
    <section className="flex flex-col gap-5 py-4 md:py-6" id="screenshot">
      ...
      <div className="[&_div.rounded-\[10px\]]:!rounded-card [&_div.rounded-\[10px\]]:!shadow-card [&_div.rounded-\[10px\]]:!border-surface-300 [&_div.rounded-\[10px\]]:!bg-white [&_img]:!border-surface-300 [&_img]:!rounded-md [&_p.text-dark-500]:!text-sm [&_p.text-dark-500]:!text-surface-500 [&_div.overflow-auto]:!overflow-x-auto">
