  ...
  return (
    <section className="flex flex-col gap-5 scroll-mt-32" id="alternatives">
      ...
      <div className="flex justify-center pt-2">
        <Link href={`/${locale}/products/${slug}/alternatives`} className="group">
          <Button as="span" variant="shadow" color="secondary">
            <div className="flex items-center justify-center gap-2">
              <Layers size={16} className="shrink-0 text-dark-500 transition-colors group-hover:text-dark-800" />
