...
export const ProductDetailCompanySection = ({ slug }: ProductDetailCompanySectionProps) => {
  ...
  return (
    <section className="flex flex-col gap-5 py-4 md:py-6" id="company-info">
      ...
      <div className="[&_p.text-dark-500]:!text-sm [&_p.text-dark-500]:!text-surface-600 [&_div.bg-dark-400]:!bg-surface-300 [&_div.bg-dark-400]:!h-px [&_p.text-dark-700]:!w-16 [&_p.text-dark-700]:!text-surface-500 [&_p.text-dark-700]:!font-normal [&_p.text-dark-700]:!text-sm [&_p.text-dark-600]:!text-surface-600 [&_p.text-dark-600]:!text-sm">
