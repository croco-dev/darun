      ...
      <div data-testid="skel-recent" className="flex w-full flex-col gap-5 md:gap-6">
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            <div className="h-5 w-16 animate-pulse rounded bg-surface-200 motion-reduce:animate-none" />
          </div>
          <div className="h-4 w-64 animate-pulse rounded bg-surface-200 motion-reduce:animate-none" />
        </div>
