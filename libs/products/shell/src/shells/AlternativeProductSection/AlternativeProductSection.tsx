    ...
    return (
      <section className="flex flex-col gap-4 md:gap-5">
        ...
        <div
          ...
          className="flex flex-col items-center justify-center rounded-card-lg border border-dashed border-dark-200 bg-surface-50/50 px-6 py-14 text-center sm:py-16"
        >
          ...
          <Link
            ...
            className="mt-6 group rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-dark-900/60 focus-visible:ring-offset-2"
          >
