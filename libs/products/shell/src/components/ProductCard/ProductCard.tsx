  ...
  return (
    ...
    >
      <div className="relative flex h-full flex-col rounded-card border border-surface-300 bg-white p-4 shadow-card transition-all duration-200 ease-out group-hover:-translate-y-1 group-hover:border-brand-300 group-hover:shadow-card-hover group-focus-visible:-translate-y-1 group-focus-visible:border-brand-300 group-focus-visible:shadow-card-hover group-focus-visible:ring-2 group-focus-visible:ring-brand-300/70 group-focus-visible:ring-offset-2 group-focus-visible:ring-offset-white active:translate-y-0 active:scale-[0.99] motion-reduce:transform-none motion-reduce:transition-none md:rounded-card-lg">
        {rank !== undefined && (
          <span className="absolute left-4 top-4 inline-flex h-8 min-w-8 items-center justify-center rounded-full bg-brand-100 px-2.5 text-xs font-bold text-brand-700 transition-transform duration-200 ease-out group-hover:scale-105 group-focus-visible:scale-105 motion-reduce:transform-none motion-reduce:transition-none md:h-9 md:min-w-9 md:px-3 md:text-sm">
            {rank}
          </span>
        )}
        <div
