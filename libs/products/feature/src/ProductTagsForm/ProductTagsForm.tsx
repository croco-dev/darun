...
export const ProductTagsForm = bind(
  useProductTagsForm,
  ({ inputValue, tags, handleInputChange, removeTag, applyTags, isSaving }) => (
    <div className="flex flex-col gap-3">
      <div className="flex flex-row gap-2">
        ...
        <Button onClick={applyTags} variant="contained" color="primary" disabled={isSaving}>
          {isSaving ? '저장 중...' : '저장'}
        </Button>
      </div>
          ...
          {tags.map(tag => (
            ...
            >
              ...
              <button
                ...
                className="text-dark-400 hover:text-dark-700 ml-0.5 rounded-full"
                title={`${tag} 태그 제거`}
              >
                <X size={12} />
              </button>
